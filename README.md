...
A minimal, modern operating system built for ultimate customization.

## Philosophy

Shary OS strips away the unnecessary to give you complete control.  
Built on musl libc, every component is selected for simplicity, security, and performance.
...
Once available, download the ISO and boot from USB or a virtual machine.
...
**Ultimate flexibility** — From embedded systems to desktop workstations, build exactly what you need.

## System Requirements

- x86_64 architecture
- 256MB RAM minimum (512MB recommended)
- 2GB disk space for the base system


## Documentation

Documentation and website are currently being prepared and will be published at a later date.
...
Interested in contributing? Feel free to open issues or reach out.
Contribution guidelines will be formalized as the project matures.

## License

Shary OS is primarily released under the BSD-3-Clause License.
